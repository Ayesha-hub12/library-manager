...
class BookCollection:
    ...
    def read_from_file(self):
        """Load saved books from a JSON file into memory. If the file doesn't exist or is corrupted, start with an empty collection."""
        try:
    ...
    def find_book(self):
        ...
        if search_type == "1":
            ...
            found_books = [
                book
                for book in self.book_list
                if search_text in book["author"].lower()
            ]
        else:
